	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			// *     b. Calls fleshScore on this document
			  ...
			  BasicDocument basic = new BasicDocument( getStringFromFile(textfile,numToCheck));
			...
			//*     b. Calls fleshScore on this document
			  ...
			  EfficientDocument efficient = new EfficientDocument(getStringFromFile(textfile,numToCheck));
			  long time2 = System.nanoTime()-timeStart2;
			// * 6. Print out the time it took to complete the loop in step 5 
			// *      (on the same line as the first print statement) followed by a newline (\n) 
			  double fast = time1/time2;
			  System.out.print(time2+"\n");
			  //System.out.println("Time faster "+fast+"\n");
		}
